...
#[gen_stub_pyclass]
#[pyclass(module = "opendal.layers", name = "Layer", subclass)]
...
// #[gen_stub_pyclass]
// #[pyclass(module = "opendal.layers", extends = PyLayer)]
// #[derive(Clone)]
...
//         let class = PyClassInitializer::from(PyLayer(Box::new(concurrent_limit.clone())))
...
// #[pyclass(module = "opendal.layers", extends = PyLayer)]
// #[derive(Clone)]
// pub struct MimeGuessLayer(opendal_layer_mime_guess::MimeGuessLayer);
...
//         let mime_guess = Self(opendal_layer_mime_guess::MimeGuessLayer::default());
//         let class =
//             PyClassInitializer::from(PyLayer(Box::new(mime_guess.clone()))).add_subclass(mime_guess);
//         Ok(class)
//     }
// }
